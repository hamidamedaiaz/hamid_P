...
import fr.unice.polytech.sophiatecheats.infrastructure.repositories.shared.SharedRestaurantRepository;
import fr.unice.polytech.sophiatecheats.infrastructure.repositories.shared.SharedUserRepository;
...
public class ApplicationConfig {
   ...
   * Utilise des repositories PARTAGÉS pour que les deux services (Restaurant et Order&Payment)
   * accèdent aux mêmes données en mémoire.
   */
  private void configure() {
    // Repositories - PARTAGÉS entre les services
    container.addComponent(UserRepository.class, SharedUserRepository.class);
    container.addComponent(RestaurantRepository.class, SharedRestaurantRepository.class);
